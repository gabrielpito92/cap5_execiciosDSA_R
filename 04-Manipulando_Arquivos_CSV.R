...
# Usando o pacote readr - excelente para ler arquivos csv
...
# Tipos de dados (para definir o tipo de dado de cada coluna)
# col_integer(): 
# col_double(): 
# col_logical(): 
# col_character(): 
...
# agora a ultima col. ficará como tipo fator
